...
interface SwipeScreenProps {
  onProfileDetails: (profile: Profile) => void;
  onNFTDate: (profile: Profile) => void;
  onMyProfile: () => void;
  onDashboard: () => void;
}
...
export function SwipeScreen({ onProfileDetails, onNFTDate, onMyProfile, onDashboard }: SwipeScreenProps) {
