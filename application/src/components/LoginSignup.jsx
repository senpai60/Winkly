  ...
  const handleInterestChange = (e) => {
    ...
    setFormData((prev) => {
      ...
      if (checked) {
        ...
        return {
          ...prev,
          interestedIn: interests.filter((interest) => interest !== value),
        };
      }
    });
  };
      ...
      >
        <div className="text-center space-y-4">
          ...
          >
            ...
            <h1 className="gradient-text-pink-blue text-4xl font-bold">
              Winkly
            </h1>
          </motion.div>
          <motion.p
          ...
          {!isLogin && (
            <>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full h-11 px-3 py-1 text-sm bg-transparent glass-card border border-white/10 rounded-md focus:border-accent outline-none"
              >
